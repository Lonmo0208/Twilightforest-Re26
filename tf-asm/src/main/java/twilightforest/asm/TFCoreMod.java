...
import twilightforest.asm.transformers.entity.*;
...
public class TFCoreMod implements ClassProcessorProvider {
	...
	public void createProcessors(Context context, Collector collector) {
		...
		// multipart - entity injection: Mixin ClientLevelMixin (primary, Iris-proof),
		// plus ASM ResolveEntitiesForRendereringTransformer (fallback for Vanilla/Sodium)
