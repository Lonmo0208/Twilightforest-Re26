...
public class TFWorldgenProvider extends FabricDynamicRegistryProvider {
	...
	protected void configure(HolderLookup.Provider registries, Entries entries) {
		// Minecraft built-in registries (namespace: twilightforest)
		...
		// Custom registries - add ALL entries for each registry
		// entries.addAll() filters by modId, so we manually iterate all entries to include
		// entries with vanilla namespaces (e.g. minecraft:oak in wood_palettes)
