	...
	public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> register) {
		...
		register.accept(TFLootTables.HEDGE_CLOTH,
			LootTable.lootTable()
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.WHITE).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.LIGHT_GRAY).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.GRAY).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.BLACK).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.RED).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.ORANGE).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.YELLOW).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.GREEN).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.LIME).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.BLUE).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.CYAN).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.LIGHT_BLUE).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.PURPLE).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.MAGENTA).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.PINK).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
					.add(LootItem.lootTableItem(Blocks.CARPET.pick(DyeColor.BROWN).asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3)))))
				.withPool(LootPool.lootPool()
		...
		register.accept(TFLootTables.QUEST_GROVE,
			LootTable.lootTable()
				.withPool(LootPool.lootPool()
					.setRolls(ConstantValue.exactly(4))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.WHITE)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.ORANGE)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.MAGENTA)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.LIGHT_BLUE)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.YELLOW)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.LIME)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.PINK)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.GRAY)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.LIGHT_GRAY)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.CYAN)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.PURPLE)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.BLUE)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.BROWN)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.GREEN)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.RED)))
					.add(LootItem.lootTableItem(Blocks.WOOL.pick(DyeColor.BLACK)))));
		...
		register.accept(TFLootTables.STRONGHOLD_CACHE,
			LootTable.lootTable()
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(Items.WOOL.pick(DyeColor.BLUE)))
					.add(LootItem.lootTableItem(Items.IRON_INGOT).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2)))))
				.withPool(LootPool.lootPool()
					.setRolls(ConstantValue.exactly(2))
					//uncommon loot
		...
		register.accept(TFLootTables.DARKTOWER_CACHE,
			LootTable.lootTable()
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(Items.WOOL.pick(DyeColor.RED)).setWeight(75))
