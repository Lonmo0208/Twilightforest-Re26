...
public class DataMapGenerator extends DataMapProvider {
	...
	protected void gather(HolderLookup.Provider provider) {
		...
		this.add2WayTransform(transformation, TFEntities.MINOTAUR, EntityTypes.ZOMBIFIED_PIGLIN);
		this.add2WayTransform(transformation, TFEntities.DEER, EntityTypes.COW);
		this.add2WayTransform(transformation, TFEntities.BOAR, EntityTypes.PIG);
		this.add2WayTransform(transformation, TFEntities.BIGHORN_SHEEP, EntityTypes.SHEEP);
		this.add2WayTransform(transformation, TFEntities.DWARF_RABBIT, EntityTypes.RABBIT);
		this.add2WayTransform(transformation, TFEntities.TINY_BIRD, EntityTypes.PARROT);
		this.add2WayTransform(transformation, TFEntities.RAVEN, EntityTypes.BAT);
		this.add2WayTransform(transformation, TFEntities.HOSTILE_WOLF, EntityTypes.WOLF);
		this.add2WayTransform(transformation, TFEntities.PENGUIN, EntityTypes.CHICKEN);
		this.add2WayTransform(transformation, TFEntities.HEDGE_SPIDER, EntityTypes.SPIDER);
		this.add2WayTransform(transformation, TFEntities.SWARM_SPIDER, EntityTypes.CAVE_SPIDER);
		this.add2WayTransform(transformation, TFEntities.WRAITH, EntityTypes.VEX);
		this.add2WayTransform(transformation, TFEntities.SKELETON_DRUID, EntityTypes.WITCH);
		this.add2WayTransform(transformation, TFEntities.CARMINITE_GHASTGUARD, EntityTypes.GHAST);
		this.add2WayTransform(transformation, TFEntities.TOWERWOOD_BORER, EntityTypes.SILVERFISH);
		this.add2WayTransform(transformation, TFEntities.MAZE_SLIME, EntityTypes.SLIME);

        Builder<EntityTransformation, EntityType<?>> zombieBuilder = this.builder(TFDataMaps.OMINOUS_FIRE);
		this.add1WayTransform(zombieBuilder, EntityTypes.VILLAGER, EntityTypes.ZOMBIE_VILLAGER);
		this.add1WayTransform(zombieBuilder, EntityTypes.PIGLIN, EntityTypes.ZOMBIFIED_PIGLIN);
		this.add1WayTransform(zombieBuilder, EntityTypes.HORSE, EntityTypes.ZOMBIE_HORSE);
		...
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("copper_block")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_cut_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_cut_copper")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_cut_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_cut_copper")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_cut_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("cut_copper")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_cut_copper_stairs")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_cut_copper_stairs")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_cut_copper_stairs")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_cut_copper_stairs")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_cut_copper_stairs")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("cut_copper_stairs")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_cut_copper_slab")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_cut_copper_slab")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_cut_copper_slab")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_cut_copper_slab")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_cut_copper_slab")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("cut_copper_slab")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_chiseled_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_chiseled_copper")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_chiseled_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_chiseled_copper")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_chiseled_copper")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("chiseled_copper")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_copper_grate")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper_grate")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper_grate")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper_grate")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper_grate")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("copper_grate")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_copper_bulb")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper_bulb")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper_bulb")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper_bulb")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper_bulb")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("copper_bulb")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_copper_trapdoor")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper_trapdoor")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper_trapdoor")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper_trapdoor")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper_trapdoor")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("copper_trapdoor")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("oxidized_copper_door")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper_door")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("weathered_copper_door")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper_door")).get().value(), 0.2F), false);
		crumble.add(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("exposed_copper_door")).get(), new CrumbledBlock(BuiltInRegistries.BLOCK.get(Identifier.withDefaultNamespace("copper_door")).get().value(), 0.2F), false);
		...
		oreMap.add(Tags.Blocks.ORES_COAL, new OreMapOreColor(MapColor.COLOR_BLACK), false);
		oreMap.add(BlockTags.IRON_ORES, new OreMapOreColor(MapColor.RAW_IRON), false);
		oreMap.add(Tags.Blocks.ORES_LAPIS, new OreMapOreColor(MapColor.LAPIS), false);
		oreMap.add(BlockTags.GOLD_ORES, new OreMapOreColor(MapColor.GOLD), false);
		oreMap.add(Tags.Blocks.ORES_REDSTONE, new OreMapOreColor(MapColor.COLOR_RED), false);
		oreMap.add(Tags.Blocks.ORES_DIAMOND, new OreMapOreColor(MapColor.DIAMOND), false);
		oreMap.add(Tags.Blocks.ORES_EMERALD, new OreMapOreColor(MapColor.EMERALD), false);
