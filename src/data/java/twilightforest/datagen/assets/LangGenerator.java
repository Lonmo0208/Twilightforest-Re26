...
public class LangGenerator extends TFLangProvider {
	...
	protected void addTranslations(HolderLookup.Provider registries) {
		...
		this.add("itemGroup.twilightforest.wip", "Twilight Forest: Work in Progress");
		...
		this.addStructure(TFStructures.FALLEN_TRUNK, "Fallen Trunk");
		this.addStructure(TFStructures.HOLLOW_TREE, "Hollow Oak Tree");
		this.addStructure(TFStructures.SWAMP_HOLLOW_TREE, "Hollow Oak Tree");
		this.addStructure(TFStructures.CAMP, "Camp");
		...
		this.addGameRule(TFGameRules.TF_PORTAL_CREATIVE_DELAY, "Player's The Twilight Forest portal delay in creative mode");
		this.addGameRuleDescription(TFGameRules.TF_PORTAL_CREATIVE_DELAY, "Time (in ticks) that a creative mode player needs to stand in The Twilight Forest portal before changing dimensions.");
		this.addGameRule(TFGameRules.TF_PORTAL_DEFAULT_DELAY, "Player's The Twilight Forest portal delay in non-creative mode");
		this.addGameRuleDescription(TFGameRules.TF_PORTAL_DEFAULT_DELAY, "Time (in ticks) that a non-creative mode player needs to stand in The Twilight Forest portal before changing dimensions.");
		...
		this.addBlock(TFBlocks.PALE_OAK_DRYING_RACK, "Pale Oak Drying Rack");
		...
		MagicPaintingVariants.MAGIC_PAINTING_LANG_HELPER.forEach((location, stringStringPair) -> {
		...
		this.translateTag(TFItemTags.CARMINITE_GEMS, "Carminite Gems");
		this.translateTag(TFItemTags.FIERY_INGOTS, "Fiery Ingots");
		this.translateTag(TFItemTags.IRONWOOD_INGOTS, "Ironwood Ingots");
		this.translateTag(TFItemTags.KNIGHTMETAL_INGOTS, "Knightmetal Ingots");
		this.translateTag(TFItemTags.STEELEAF_INGOTS, "Steeleaf Ingots");
		this.translateTag(TFItemTags.PAPER, "Papers");
		this.translateTag(TFItemTags.RAW_MATERIALS_IRONWOOD, "Raw Ironwood");
		this.translateTag(TFItemTags.RAW_MATERIALS_KNIGHTMETAL, "Raw Knightmetal");
		this.translateTag(TFItemTags.STORAGE_BLOCKS_ARCTIC_FUR, "Arctic Fur Storage Blocks");
		this.translateTag(TFItemTags.STORAGE_BLOCKS_CARMINITE, "Carminite Storage Blocks");
		...
		this.translateTag(TFItemTags.BANNED_UNCRAFTING_INGREDIENTS, "Banned Uncrafting Ingredients");
		this.translateTag(TFItemTags.BANISTERS, "Banisters");
		this.translateTag(TFItemTags.CANOPY_LOGS, "Canopy Logs");
		this.translateTag(TFItemTags.DARKWOOD_LOGS, "Darkwood Logs");
		this.translateTag(TFItemTags.FIERY_VIAL, "Fiery Vials");
		this.translateTag(TFItemTags.KEPT_ON_DEATH, "Kept on Death");
		this.translateTag(TFItemTags.BLOCK_AND_CHAIN_ENCHANTABLE, "Block and Chain Enchantable");
		this.translateTag(TFItemTags.KOBOLD_PACIFICATION_BREADS, "Kobold Pacification Items");
		this.translateTag(TFItemTags.BOAR_TEMPT_ITEMS, "Boar Temptables");
		this.translateTag(TFItemTags.DEER_TEMPT_ITEMS, "Deer Temptables");
		this.translateTag(TFItemTags.DWARF_RABBIT_TEMPT_ITEMS, "Dwarf Rabbit Temptables");
		this.translateTag(TFItemTags.PENGUIN_TEMPT_ITEMS, "Penguin Temptables");
		...
		this.translateTag(TFItemTags.REPAIRS_FIERY_TOOLS, "Repairs Fiery Tools");
		this.translateTag(TFItemTags.REPAIRS_GIANT_TOOLS, "Repairs Giant Tools");
		this.translateTag(TFItemTags.REPAIRS_ICE_TOOLS, "Repairs Ice Tools");
		this.translateTag(TFItemTags.REPAIRS_IRONWOOD_TOOLS, "Repairs Ironwood Tools");
		...
		this.translateTag(TFItemTags.TWILIGHT_OAK_LOGS, "Twilight Oak Logs");
		this.translateTag(TFItemTags.UNCRAFTING_IGNORES_COST, "Uncrafting Table Ignores Cost");
		this.translateTag(TFItemTags.WIP, "Work In Progress Items");
		this.translateTag(TFItemTags.IMMUNE_TO_THORNS, "Immune to Thorns");
		this.translateTag(TFItemTags.SCEPTERS, "Scepters");
