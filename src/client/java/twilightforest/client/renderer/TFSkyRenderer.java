...
public class TFSkyRenderer implements AutoCloseable {
	...
	// Used to store whether the sky should be darkened
	private static boolean renderDarkDisc = false;
	...
	public static void extractLevelRender(ClientLevel level, float partialTicks) {
		renderDarkDisc = shouldDarkenSky(level, partialTicks);
	}
