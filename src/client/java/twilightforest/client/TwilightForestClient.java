...
public class TwilightForestClient implements ClientModInitializer {
	...
	private void registerEntityRenderers() {
		// Living entities
		EntityRendererRegistry.register(TFEntities.BOAR.get(), BoarRenderer::new);
		EntityRendererRegistry.register(TFEntities.BIGHORN_SHEEP.get(), BighornRenderer::new);
		EntityRendererRegistry.register(TFEntities.DEER.get(), DeerRenderer::new);
		EntityRendererRegistry.register(TFEntities.REDCAP.get(), RedcapRenderer::new);
		EntityRendererRegistry.register(TFEntities.SKELETON_DRUID.get(), SkeletonDruidRenderer::new);
		EntityRendererRegistry.register(TFEntities.HOSTILE_WOLF.get(), HostileWolfRenderer::new);
		EntityRendererRegistry.register(TFEntities.WRAITH.get(), WraithRenderer::new);
		EntityRendererRegistry.register(TFEntities.HYDRA.get(), HydraRenderer::new);
		...
		EntityRendererRegistry.register(TFEntities.HYDRA_HEAD.get(), hydraHeadProvider);
		@SuppressWarnings({"unchecked", "rawtypes"})
		...
		EntityRendererRegistry.register(TFEntities.HYDRA_NECK.get(), hydraNeckProvider);
		EntityRendererRegistry.register(TFEntities.LICH.get(), LichRenderer::new);
		EntityRendererRegistry.register(TFEntities.PENGUIN.get(), m -> new BirdRenderer<>(m, new PenguinModel(m.bakeLayer(TFModelLayers.PENGUIN)), new PenguinModel(m.bakeLayer(TFModelLayers.PENGUIN_BABY)), 0.375F, "penguin.png"));
		EntityRendererRegistry.register(TFEntities.LICH_MINION.get(), LichMinionRenderer::new);
		EntityRendererRegistry.register(TFEntities.LOYAL_ZOMBIE.get(), LoyalZombieRenderer::new);
		EntityRendererRegistry.register(TFEntities.TINY_BIRD.get(), TinyBirdRenderer::new);
		EntityRendererRegistry.register(TFEntities.SQUIRREL.get(), SquirrelRenderer::new);
		EntityRendererRegistry.register(TFEntities.DWARF_RABBIT.get(), BunnyRenderer::new);
		...
		EntityRendererRegistry.register(TFEntities.QUEST_RAM.get(), QuestRamRenderer::new);
		EntityRendererRegistry.register(TFEntities.KOBOLD.get(), KoboldRenderer::new);
		EntityRendererRegistry.register(TFEntities.MOSQUITO_SWARM.get(), MosquitoSwarmRenderer::new);
		EntityRendererRegistry.register(TFEntities.DEATH_TOME.get(), DeathTomeRenderer::new);
		EntityRendererRegistry.register(TFEntities.MINOTAUR.get(), MinotaurRenderer::new);
		EntityRendererRegistry.register(TFEntities.MINOSHROOM.get(), MinoshroomRenderer::new);
		EntityRendererRegistry.register(TFEntities.FIRE_BEETLE.get(), FireBeetleRenderer::new);
		EntityRendererRegistry.register(TFEntities.SLIME_BEETLE.get(), SlimeBeetleRenderer::new);
		EntityRendererRegistry.register(TFEntities.PINCH_BEETLE.get(), PinchBeetleRenderer::new);
		...
		EntityRendererRegistry.register(TFEntities.CARMINITE_GOLEM.get(), CarminiteGolemRenderer::new);
		EntityRendererRegistry.register(TFEntities.TOWERWOOD_BORER.get(), TowerwoodBorerRenderer::new);
		EntityRendererRegistry.register(TFEntities.CARMINITE_GHASTGUARD.get(), CarminiteGhastRenderer::new);
		EntityRendererRegistry.register(TFEntities.UR_GHAST.get(), UrGhastRenderer::new);
		EntityRendererRegistry.register(TFEntities.BLOCKCHAIN_GOBLIN.get(), BlockChainGoblinRenderer::new);
		EntityRendererRegistry.register(TFEntities.UPPER_GOBLIN_KNIGHT.get(), UpperGoblinKnightRenderer::new);
		EntityRendererRegistry.register(TFEntities.LOWER_GOBLIN_KNIGHT.get(), LowerGoblinKnightRenderer::new);
		EntityRendererRegistry.register(TFEntities.HELMET_CRAB.get(), HelmetCrabRenderer::new);
		EntityRendererRegistry.register(TFEntities.KNIGHT_PHANTOM.get(), KnightPhantomRenderer::new);
		EntityRendererRegistry.register(TFEntities.NAGA.get(), NagaRenderer::new);
		@SuppressWarnings({"unchecked", "rawtypes"})
		...
		EntityRendererRegistry.register(TFEntities.NAGA_SEGMENT.get(), nagaSegmentProvider);
		...
		EntityRendererRegistry.register(TFEntities.REDCAP_SAPPER.get(), RedcapSapperRenderer::new);
		EntityRendererRegistry.register(TFEntities.MAZE_SLIME.get(), MazeSlimeRenderer::new);
		EntityRendererRegistry.register(TFEntities.YETI.get(), YetiRenderer::new);
		...
		EntityRendererRegistry.register(TFEntities.ALPHA_YETI.get(), AlphaYetiRenderer::new);
		EntityRendererRegistry.register(TFEntities.WINTER_WOLF.get(), WinterWolfRenderer::new);
		EntityRendererRegistry.register(TFEntities.SNOW_GUARDIAN.get(), SnowGuardianRenderer::new);
		EntityRendererRegistry.register(TFEntities.STABLE_ICE_CORE.get(), StableIceCoreRenderer::new);
		EntityRendererRegistry.register(TFEntities.UNSTABLE_ICE_CORE.get(), UnstableIceCoreRenderer::new);
		EntityRendererRegistry.register(TFEntities.SNOW_QUEEN.get(), SnowQueenRenderer::new);
		@SuppressWarnings({"unchecked", "rawtypes"})
		EntityRendererProvider<Entity> iceShieldProvider = ctx -> (EntityRenderer) new SnowQueenIceShieldRenderer(ctx);
		EntityRendererRegistry.register(TFEntities.SNOW_QUEEN_ICE_SHIELD.get(), iceShieldProvider);
		...
		EntityRendererRegistry.register(TFEntities.LICH_BOMB.get(), c -> new CustomProjectileTextureRenderer(c, net.minecraft.resources.Identifier.withDefaultNamespace("textures/item/magma_cream.png"), 1.0F, true, true));
		...
		// Boats
		EntityRendererRegistry.register(TFEntities.TWILIGHT_OAK_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.TWILIGHT_OAK_BOAT));
		EntityRendererRegistry.register(TFEntities.TWILIGHT_OAK_CHEST_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.TWILIGHT_OAK_CHEST_BOAT));
		EntityRendererRegistry.register(TFEntities.CANOPY_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.CANOPY_BOAT));
		EntityRendererRegistry.register(TFEntities.CANOPY_CHEST_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.CANOPY_CHEST_BOAT));
		EntityRendererRegistry.register(TFEntities.MANGROVE_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.MANGROVE_BOAT));
		EntityRendererRegistry.register(TFEntities.MANGROVE_CHEST_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.MANGROVE_CHEST_BOAT));
		EntityRendererRegistry.register(TFEntities.DARK_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.DARK_BOAT));
		EntityRendererRegistry.register(TFEntities.DARK_CHEST_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.DARK_CHEST_BOAT));
		EntityRendererRegistry.register(TFEntities.TIME_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.TIME_BOAT));
		EntityRendererRegistry.register(TFEntities.TIME_CHEST_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.TIME_CHEST_BOAT));
		EntityRendererRegistry.register(TFEntities.TRANSFORMATION_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.TRANSFORMATION_BOAT));
		EntityRendererRegistry.register(TFEntities.TRANSFORMATION_CHEST_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.TRANSFORMATION_CHEST_BOAT));
		EntityRendererRegistry.register(TFEntities.MINING_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.MINING_BOAT));
		EntityRendererRegistry.register(TFEntities.MINING_CHEST_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.MINING_CHEST_BOAT));
		EntityRendererRegistry.register(TFEntities.SORTING_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.SORTING_BOAT));
		EntityRendererRegistry.register(TFEntities.SORTING_CHEST_BOAT.get(), context -> new BoatRenderer(context, TFModelLayers.SORTING_CHEST_BOAT));
	}
	...
	private void registerBlockEntityRenderers() {
		...
		BlockEntityRendererRegistry.register(TFBlockEntities.TF_CHEST, TFChestRenderer::new);
		BlockEntityRendererRegistry.register(TFBlockEntities.TF_TRAPPED_CHEST, TFChestRenderer::new);
