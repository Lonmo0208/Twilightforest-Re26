...
public class UnbakedConnectedTextureModel implements BlockStateModel.Unbaked {
	...
	public UnbakedConnectedTextureModel(com.mojang.datafixers.util.Pair<Vector3f, Vector3f> element, Set<Direction> connectedFaces, boolean renderOnDisabledFaces, List<Block> connectableBlocks, int baseTintIndex, int baseEmissivity, int tintIndex, int emissivity, boolean translucent) {
	...
	public BlockStateModel bake(ModelBaker baker) {
		...
		return bakeInternal(textureSlots, baker, state, useAmbientOcclusion, usesBlockLight, null);
	}

	public BlockStateModel bakeInternal(TextureSlots textureSlots, ModelBaker baker, ModelState state, boolean useAmbientOcclusion, boolean usesBlockLight, @Nullable ContextMap additionalProperties) {
	...
	@Nullable
	public ModelDebugName getDebugName() {
		return DEBUG_NAME;
	}
}
