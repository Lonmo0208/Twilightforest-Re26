...
public class ColorHandler {
	public static final Int2IntFunction CANOPY_COLORIZER = new Int2IntFunction() {
		@Override
		public int applyAsInt(int color) {
			return 0xFF000000 | (((color & 0xFEFEFE) + 0x469A66) / 2);
		}
		@Override
	...
	public static final Int2IntFunction MANGROVE_COLORIZER = new Int2IntFunction() {
		@Override
		public int applyAsInt(int color) {
			return 0xFF000000 | (((color & 0xFEFEFE) + 0xC0E694) / 2);
		}
		@Override
		public int get(int color) {
			return applyAsInt(color);
