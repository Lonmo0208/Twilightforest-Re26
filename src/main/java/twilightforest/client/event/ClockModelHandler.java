...
public class ClockModelHandler {
    ...
    public static void onModifyBakingResult(ModelEvent.ModifyBakingResult event) {
        ...
        try {
            ...
            SelectItemModel.ModelSelector<Object> newSelector = new SelectItemModel.ModelSelector<>() {
                @Override
                public ItemModel get(Object value, net.minecraft.client.multiplayer.ClientLevel context) {
