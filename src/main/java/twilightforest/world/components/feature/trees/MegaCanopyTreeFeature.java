...
public class MegaCanopyTreeFeature extends CanopyTreeFeature {
	...
	public MegaCanopyTreeFeature() {
	}

	protected MegaCanopyTreeFeature(TFTreeFeatureConfig config) {
		super(config);
	}

	@Override
	public MapCodec<? extends Feature> codec() {
		return TFTreeFeatureConfig.MAP_CODEC.xmap(MegaCanopyTreeFeature::new, f -> f.config);
	}

	@Override
	protected TFTreeFeature create(TFTreeFeatureConfig config) {
		return new MegaCanopyTreeFeature(config);
	}
