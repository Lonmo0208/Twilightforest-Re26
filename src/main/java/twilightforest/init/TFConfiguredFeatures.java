...
public final class TFConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<Feature> context) {
		...
		context.register(DARKWOOD_TREE,  new DarkCanopyTreeFeature(TreeConfigurations.DARKWOOD_TREE));
		context.register(HOMEGROWN_DARKWOOD_TREE,  new DarkCanopyTreeFeature(TreeConfigurations.HOMEGROWN_DARKWOOD_TREE));
		context.register(DARKWOOD_LANTERN_TREE,  new DarkCanopyTreeFeature(TreeConfigurations.DARKWOOD_LANTERN_TREE));
		...
		context.register(DARK_FOREST_OAK_TREE,  new DarkCanopyTreeFeature(TreeConfigurations.DARK_FOREST_OAK_TREE));
		context.register(DARK_FOREST_BIRCH_TREE,  new DarkCanopyTreeFeature(TreeConfigurations.DARK_FOREST_BIRCH_TREE));
		context.register(DARK_OAK_BUSH,  new DarkCanopyTreeFeature(TreeConfigurations.DARK_OAK_BUSH));
		...
		context.register(DARK_FOREST_TREES, new RandomSelectorFeature(ImmutableList.of(new WeightedPlacedFeature(PlacementUtils.inlinePlaced(features.getOrThrow(DARK_FOREST_BIRCH_TREE)), 0.2F), new WeightedPlacedFeature(PlacementUtils.inlinePlaced(features.getOrThrow(DARK_FOREST_OAK_TREE)), 0.2F), new WeightedPlacedFeature(PlacementUtils.inlinePlaced(features.getOrThrow(DARK_OAK_BUSH)), 0.4F)), PlacementUtils.inlinePlaced(features.getOrThrow(DARKWOOD_TREE))));
