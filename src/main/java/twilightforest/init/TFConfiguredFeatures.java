...
public final class TFConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		context.register(LAKE_FROZEN, new ConfiguredFeature<>(TFFeatures.SMALL_LAKE, new TFSmallLakeFeature.Configuration(BlockStateProvider.simple(Blocks.WATER), null, BlockStateProvider.simple(Blocks.ICE))));

		registerTemplateFeatures(context);

		context.register(BIG_MUSHGLOOM, new ConfiguredFeature<>(TFFeatures.BIG_MUSHGLOOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(TFBlocks.HUGE_MUSHGLOOM.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.TRUE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), BlockStateProvider.simple(TFBlocks.HUGE_MUSHGLOOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.FALSE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), 1, BlockPredicate.matchesTag(TFBlockTags.HUGE_MUSHGLOOM_PLACEABLE))));
		...
		context.register(MAYAPPLE, new ConfiguredFeature<>(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.MAYAPPLE))));
		context.register(FIDDLEHEAD, new ConfiguredFeature<>(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.FIDDLEHEAD))));
		...
		context.register(MUSHGLOOM_CLUSTER, new ConfiguredFeature<>(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.MUSHGLOOM))));
		...
		context.register(IRON_OREBERRIES, new ConfiguredFeature<>(TFFeatures.OREBERRY_BUSHES, new BlockStateConfiguration(TFBlocks.IRON_OREBERRY_BUSH.defaultBlockState().setValue(BlockStateProperties.AGE_3, 3))));
		context.register(GOLD_OREBERRIES, new ConfiguredFeature<>(TFFeatures.OREBERRY_BUSHES, new BlockStateConfiguration(TFBlocks.GOLD_OREBERRY_BUSH.defaultBlockState().setValue(BlockStateProperties.AGE_3, 3))));
		context.register(COPPER_OREBERRIES, new ConfiguredFeature<>(TFFeatures.OREBERRY_BUSHES, new BlockStateConfiguration(TFBlocks.COPPER_OREBERRY_BUSH.defaultBlockState().setValue(BlockStateProperties.AGE_3, 3))));
		context.register(ESSENCE_OREBERRIES, new ConfiguredFeature<>(TFFeatures.OREBERRY_BUSHES, new BlockStateConfiguration(TFBlocks.ESSENCE_OREBERRY_BUSH.defaultBlockState().setValue(BlockStateProperties.AGE_3, 3))));
		...
		context.register(RASPBERRY_BUSHES, new ConfiguredFeature<>(TFFeatures.BERRY_BUSH, new BerryBushConfig(TFBlocks.RASPBERRY_BUSH.defaultBlockState(), TFBlockTags.TF_BERRY_BUSHES_SURVIVE, true)));
		context.register(BLUEBERRY_BUSHES, new ConfiguredFeature<>(TFFeatures.BERRY_BUSH, new BerryBushConfig(TFBlocks.BLUEBERRY_BUSH.defaultBlockState(), TFBlockTags.TF_BERRY_BUSHES_SURVIVE, true)));
		context.register(BLACKBERRY_BUSHES, new ConfiguredFeature<>(TFFeatures.BERRY_BUSH, new BerryBushConfig(TFBlocks.BLACKBERRY_BUSH.defaultBlockState(), TFBlockTags.TF_BERRY_BUSHES_SURVIVE, true)));
		context.register(MALOBERRY_BUSHES, new ConfiguredFeature<>(TFFeatures.BERRY_BUSH, new BerryBushConfig(TFBlocks.MALOBERRY_BUSH.defaultBlockState(), TFBlockTags.TF_BERRY_BUSHES_SURVIVE, true)));
		...
		context.register(TROLL_ROOTS, new ConfiguredFeature<>(TFFeatures.TROLL_VINES, new BlockStateConfiguration(TFBlocks.TROLLVIDR.defaultBlockState())));
		...
		context.register(TROLL_HUGE_RED_MUSHROOMS, new ConfiguredFeature<>(TFFeatures.TROLL_HUGE_RED_MUSHROOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(Blocks.RED_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), BlockStateProvider.simple(Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.FALSE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), 2, BlockPredicate.matchesTag(BlockTags.HUGE_RED_MUSHROOM_CAN_PLACE_ON))));
		context.register(TROLL_HUGE_BROWN_MUSHROOMS, new ConfiguredFeature<>(TFFeatures.TROLL_HUGE_BROWN_MUSHROOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(Blocks.BROWN_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.TRUE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), BlockStateProvider.simple(Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.FALSE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), 3, BlockPredicate.matchesTag(BlockTags.HUGE_BROWN_MUSHROOM_CAN_PLACE_ON))));
		context.register(TROLL_MUSHGLOOMS, new ConfiguredFeature<>(TFFeatures.UNDERGROUND_PLANTS_IN_STRUCTURE, new BlockStateConfiguration(TFBlocks.MUSHGLOOM.defaultBlockState())));
		...
		context.register(TF_OAK_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG, new HollowLogConfig(TFBlocks.TWILIGHT_OAK_LOG.defaultBlockState(), TFBlocks.HOLLOW_TWILIGHT_OAK_LOG_HORIZONTAL.defaultBlockState())));
		context.register(CANOPY_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG, new HollowLogConfig(TFBlocks.CANOPY_LOG.defaultBlockState(), TFBlocks.HOLLOW_CANOPY_LOG_HORIZONTAL.defaultBlockState())));
		context.register(MANGROVE_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG, new HollowLogConfig(TFBlocks.MANGROVE_LOG.defaultBlockState(), TFBlocks.HOLLOW_MANGROVE_LOG_HORIZONTAL.defaultBlockState())));
		context.register(OAK_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG, new HollowLogConfig(Blocks.OAK_LOG.defaultBlockState(), TFBlocks.HOLLOW_OAK_LOG_HORIZONTAL.defaultBlockState())));
		context.register(SPRUCE_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG, new HollowLogConfig(Blocks.SPRUCE_LOG.defaultBlockState(), TFBlocks.HOLLOW_SPRUCE_LOG_HORIZONTAL.defaultBlockState())));
		context.register(BIRCH_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG, new HollowLogConfig(Blocks.BIRCH_LOG.defaultBlockState(), TFBlocks.HOLLOW_BIRCH_LOG_HORIZONTAL.defaultBlockState())));
		...
		context.register(DARK_MUSHGLOOMS, new ConfiguredFeature<>(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.MUSHGLOOM))));
		...
		context.register(UBEROUS_SOIL_PATCH_BIG, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB, new DiskConfiguration(BlockStateProvider.simple(TFBlocks.UBEROUS_SOIL), BlockPredicate.matchesBlocks(Blocks.PODZOL, Blocks.COARSE_DIRT, Blocks.DIRT), UniformInt.of(4, 8), 1)));
		context.register(UBEROUS_SOIL_PATCH_SMALL, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB, new DiskConfiguration(BlockStateProvider.simple(TFBlocks.UBEROUS_SOIL), BlockPredicate.matchesBlocks(Blocks.PODZOL, Blocks.COARSE_DIRT, Blocks.DIRT), UniformInt.of(2, 3), 0)));
		context.register(TROLL_CAVE_MYCELIUM, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB, new DiskConfiguration(BlockStateProvider.simple(Blocks.MYCELIUM), BlockPredicate.matchesBlocks(Blocks.STONE, TFBlocks.DEADROCK), UniformInt.of(3, 5), 0)));
		context.register(TROLL_CAVE_DIRT, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB, new DiskConfiguration(BlockStateProvider.simple(Blocks.DIRT), BlockPredicate.matchesBlocks(Blocks.STONE, TFBlocks.DEADROCK), UniformInt.of(2, 5), 0)));
		...
		context.register(MEGA_CANOPY_TREE, new ConfiguredFeature<>(TFFeatures.MEGA_CANOPY, TreeConfigurations.MEGA_CANOPY));
		...
		context.register(DARKWOOD_TREE, new ConfiguredFeature<>(TFFeatures.DARK_CANOPY_TREE, TreeConfigurations.DARKWOOD_TREE));
		context.register(HOMEGROWN_DARKWOOD_TREE, new ConfiguredFeature<>(TFFeatures.DARK_CANOPY_TREE, TreeConfigurations.HOMEGROWN_DARKWOOD_TREE));
		context.register(DARKWOOD_LANTERN_TREE, new ConfiguredFeature<>(TFFeatures.DARK_CANOPY_TREE, TreeConfigurations.DARKWOOD_LANTERN_TREE));
		context.register(TIME_TREE, new ConfiguredFeature<>(TFFeatures.TREE_OF_TIME, TreeConfigurations.TIME_TREE));
		context.register(TRANSFORMATION_TREE, new ConfiguredFeature<>(Feature.TREE, TreeConfigurations.TRANSFORM_TREE));
		context.register(MINING_TREE, new ConfiguredFeature<>(TFFeatures.MINERS_TREE, TreeConfigurations.MINING_TREE));
		context.register(SORTING_TREE, new ConfiguredFeature<>(Feature.TREE, TreeConfigurations.SORT_TREE));
		context.register(FOREST_MEGA_OAK_TREE, new ConfiguredFeature<>(TFFeatures.MEGA_OAK, TreeConfigurations.FOREST_MEGA_OAK));
		context.register(SAVANNAH_MEGA_OAK_TREE, new ConfiguredFeature<>(TFFeatures.MEGA_OAK, TreeConfigurations.SAVANNAH_MEGA_OAK));
		...
		context.register(BROWN_CANOPY_MUSHROOM_TREE, new ConfiguredFeature<>(TFFeatures.CANOPY_BROWN_MUSHROOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(Blocks.BROWN_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.TRUE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), BlockStateProvider.simple(Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.FALSE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), 3, BlockPredicate.matchesTag(BlockTags.HUGE_BROWN_MUSHROOM_CAN_PLACE_ON))));
		...
		context.register(CANOPY_RED_VANILLA_MUSHROOM, new ConfiguredFeature<>(TFFeatures.CANOPY_RED_VANILLA_MUSHROOM, redCanopyMushroom));
		context.register(CANOPY_RED_SMOOTH_MUSHROOM, new ConfiguredFeature<>(TFFeatures.CANOPY_RED_SMOOTH_MUSHROOM, redCanopyMushroom));
		context.register(CANOPY_RED_SPHEROID_MUSHROOM, new ConfiguredFeature<>(TFFeatures.CANOPY_RED_SPHEROID_MUSHROOM, redCanopyMushroom));
		context.register(CANOPY_RED_FLAT_MUSHROOM, new ConfiguredFeature<>(TFFeatures.CANOPY_RED_FLAT_MUSHROOM, redCanopyMushroom));

		context.register(RED_CANOPY_MUSHROOM_TREE, new ConfiguredFeature<>(TFFeatures.WEIGHTED_LIST_SELECTOR, new WeightedListFeatureConfig(WeightedList.<Holder<PlacedFeature>>builder()
		...
		context.register(LARGE_WINTER_TREE, new ConfiguredFeature<>(TFFeatures.LARGE_WINTER_TREE, TreeConfigurations.LARGE_WINTER));
		context.register(SNOWY_SPRUCE_TREE, new ConfiguredFeature<>(TFFeatures.SNOW_TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.SPRUCE_LOG), new StraightTrunkPlacer(5, 2, 1), BlockStateProvider.simple(Blocks.SPRUCE_LEAVES), new SpruceFoliagePlacer(UniformInt.of(2, 3), UniformInt.of(0, 2), UniformInt.of(1, 2)), new TwoLayersFeatureSize(2, 0, 2), BlockStateProvider.simple(Blocks.DIRT)).ignoreVines().build()));
		context.register(DARK_FOREST_OAK_TREE, new ConfiguredFeature<>(TFFeatures.DARK_CANOPY_TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.OAK_LOG), new StraightTrunkPlacer(4, 2, 0), BlockStateProvider.simple(Blocks.OAK_LEAVES), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1), BlockStateProvider.simple(Blocks.DIRT)).ignoreVines().build()));
		...
		context.register(DARK_OAK_BUSH, new ConfiguredFeature<>(TFFeatures.DARK_CANOPY_TREE, TreeConfigurations.OAK_BUSH));
	...
	private static void registerTemplateFeatures(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		context.register(SIMPLE_WELL, new ConfiguredFeature<>(TFFeatures.SIMPLE_WELL, simpleWellConfig));
		...
		context.register(FANCY_WELL, new ConfiguredFeature<>(TFFeatures.FANCY_WELL, fancyWellConfig));
		...
		context.register(DRUID_HUT, new ConfiguredFeature<>(TFFeatures.DRUID_HUT, hutConfig));

		context.register(GRAVEYARD, new ConfiguredFeature<>(TFFeatures.GRAVEYARD, FeatureConfiguration.NONE));
	}
}