...
public class TFRegistries {
	...
	// Datapack registries (loaded from JSON via DynamicRegistries.register())
	// No FabricRegistryBuilder needed - these are accessed through RegistryAccess at runtime

	public static final class Keys {
		public static final String REGISTRY_NAMESPACE = "twilightforest";
