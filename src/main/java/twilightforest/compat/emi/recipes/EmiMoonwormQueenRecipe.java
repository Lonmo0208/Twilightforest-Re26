...
public class EmiMoonwormQueenRecipe extends TFEmiRecipe<MoonwormQueenRepairRecipe> {
	...
	public EmiMoonwormQueenRecipe() {
		super(VanillaEmiRecipeCategories.CRAFTING, new RecipeHolder<>(ResourceKey.create(Registries.RECIPE, TFRecipes.MOONWORM_QUEEN_REPAIR_RECIPE.getId()), new MoonwormQueenRepairRecipe()), TwilightForestMod.prefix("/moonworm_queen_repairing"), RecipeViewerConstants.GENERIC_RECIPE_WIDTH + 2, RecipeViewerConstants.GENERIC_RECIPE_HEIGHT);
	}
