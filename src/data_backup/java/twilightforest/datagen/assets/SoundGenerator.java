...
public class SoundGenerator extends TFSoundProvider {
	...
	public void registerSounds() {
		...
		this.generateExistingSoundWithSubtitle(TFSounds.DRYING_RACK_ADD_ITEM, SoundEvents.ITEM_FRAME_ADD_ITEM, "Drying Rack adds item");
		this.generateExistingSoundWithSubtitle(TFSounds.DRYING_RACK_REMOVE_ITEM, SoundEvents.ITEM_FRAME_ADD_ITEM, "Drying Rack removes item");
		...
		this.generateNewSoundMC(TFSounds.CYCLE_MAPS, "item/book/open_flip1", 1, "Cycles maps");
		this.generateNewSoundMC(TFSounds.CYCLE_MAPS_EMPTY, "item/book/open_flip2", 1, "No maps to cycle");
		this.generateNewSoundWithSubtitle(TFSounds.DOUBLE_JUMP, "random/travellers/double_jump", 1, "Double jumps");
		this.generateNewSoundWithSubtitle(TFSounds.PERFECT_DODGE, "random/travellers/perfect_dodge", 1, "Perfectly dodges");
		this.generateNewSoundWithSubtitle(TFSounds.SIDE_STEP, "random/travellers/side_step", 1, "Side steps");
		this.generateNewSoundWithSubtitle(TFSounds.SIDE_STEP_CHARGED, "random/travellers/side_step_ready", 1, "Side step readied");
		this.generateExistingSoundWithSubtitle(TFSounds.SWAP_HOTBAR, SoundEvents.ARMOR_EQUIP_LEATHER.value(), "Swaps hotbar");
		this.generateExistingSoundWithSubtitle(TFSounds.GOGGLES_ZOOM_IN, SoundEvents.SPYGLASS_USE, "Zooms in");
		this.generateExistingSoundWithSubtitle(TFSounds.GOGGLES_ZOOM_OUT, SoundEvents.SPYGLASS_STOP_USING, "Zooms out");
